...
#define K_VIZINHOS 5//3//vizinhos que serão avalidados para determinar o valor do atributo alvo

//glucose e insulina, segundo e sexto
...
int main(){
    short int i, j, escolhido_teste=0, cont, i_eucli, votacao;
    ...
    //escolhido_teste=0;
//aqui:
    for(escolhido_teste=0;escolhido_teste< LINHAS_DADOS;escolhido_teste++){
    ...
    //    printf("RESULTADO votacao %d\n", votacao);
        ...
        /*switch(votacao){
            case 0:
            case 1:*/
        if(votacao<=K_VIZINHOS/2){
                printf("NAO diabetico -> ");
